...
const ResearchSection = () => {
  ...
  return (
    <div id="research-section" className="py-24 bg-gradient-to-b from-hbo-charcoal to-hbo-charcoal/90 text-white">
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-8 mb-16">
            {researchData.map((item, index) => (
              <div key={index} className="bg-white/5 backdrop-blur-sm p-6 rounded-2xl border border-white/10 animate-scale-up hover:transform hover:scale-105 transition-all duration-300">
          ...
          <div className="text-center">
            ...
            <Button 
              ...
              className={cn(
                "bg-hbo-gold hover:bg-hbo-gold/90 text-hbo-charcoal rounded-full px-8 py-6 text-lg font-medium transform transition-transform duration-300 hover:scale-105"
              )}
            >
