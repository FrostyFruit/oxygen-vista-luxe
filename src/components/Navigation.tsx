...
const Navigation = () => {
  ...
  return <div className="w-full backdrop-blur-md border-b border-white/10 bg-[#f4f3f0] sticky top-0 z-50">
      <div className="container mx-auto px-3 py-2 md:px-4 md:py-3 flex justify-between items-center">
        <div className="flex-1 flex justify-center md:justify-start">
          <a href="https://www.hyperbarichq.com/providers" className="text-hbo-charcoal hover:text-hbo-gold transition-colors font-libre text-sm md:text-base">PROVIDERS</a>
        </div>
        ...
        <div className="flex md:hidden flex-1 justify-center">
          <a href="https://www.hyperbarichq.com/" className="flex items-center transform hover:scale-105 transition-transform">
            <img alt="Hyperbaric HQ Logo" className="h-8" src="/lovable-uploads/36208eca-527e-4ee7-843c-06ba3c9308e9.png" />
          </a>
        </div>
        ...
        <div className="flex-1 flex justify-end items-center">
          {isMobile ? <button onClick={toggleMobileMenu} className="p-2 text-hbo-charcoal focus:outline-none" aria-label="Toggle menu">
              ...
              <div className="hidden md:flex items-center gap-2 ml-4">
                ...
                <a href="https://www.hyperbarichq.com/auth/signup" className="w-8 h-8 rounded-full bg-gradient-to-br from-hbo-emerald to-hbo-gold/80 flex items-center justify-center text-white shadow-md hover:opacity-90 transition-opacity">
      ...
      {mobileMenuOpen && <div className="md:hidden fixed top-[40px] left-0 right-0 bg-[#f4f3f0] border-b border-white/10 shadow-lg z-50 animate-fade-in">
          <div className="p-4 flex flex-col space-y-3">
            ...
            <a href="https://www.hyperbarichq.com/auth/signup" className="flex items-center gap-2 py-2 hover:text-hbo-gold transition-colors">
