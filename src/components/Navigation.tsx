...
const Navigation = () => {
  ...
  return (
    <div className="w-full backdrop-blur-md border-b border-white/10 bg-[F4F3F0] bg-[#f4f3f0] sticky top-0 z-50">
        ...
        <div className="flex-1 flex justify-end items-center">
          {isMobile ? (
            <button 
              ...
              className="p-2 text-hbo-charcoal focus:outline-none"
      ...
      {/* Mobile Menu */}
      {mobileMenuOpen && (
        <div className="md:hidden absolute top-full left-0 right-0 bg-[#f4f3f0] border-b border-white/10 shadow-lg z-50 animate-fade-in">
